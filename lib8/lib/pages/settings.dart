...
class _SettingsState extends State<Settings> {
  ...
  final List<Map<String, String>> faqs = [
    {"question": "How to use this app?", "answer": "You can navigate through the menu to explore features."},
    {"question": "Is this app free?", "answer": "Yes, this app is completely free to use!"},
    {"question": "How do I seek Help?", "answer": "You can contact me at ajmerapujan22@gmail.com"},
    {"question": "Is this app Open-Source", "answer": "Yes the app is Open Source and can find the complete code at github.com/Pujan-Ajmera"},
  ];
      ...
      body: Padding(
        ...
        child: ListView(
          children: [
            ...
            SizedBox(height: 20),
            Accordion(
              maxOpenSections: 1, // Allows only one section to be open at a time
