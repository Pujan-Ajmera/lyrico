...
class _SearchPageState extends State<SearchPage> {
  void initState() {
    super.initState();
    // Set the status bar color when returning to home page
    SystemChrome.setSystemUIOverlayStyle(SystemUiOverlayStyle(
      statusBarColor: MyColors().color2_dark, // Adjust to your theme
      statusBarIconBrightness: Brightness.light, // Change to dark if using light theme
    ),);
  }
  @override
  ...
  Widget build(BuildContext context) {
    ...
    SystemChrome.setSystemUIOverlayStyle(SystemUiOverlayStyle(
      statusBarColor: MyColors().color2_dark, // Set your desired color
